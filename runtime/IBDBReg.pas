...
{$IFDEF IB6_ONLY}
  if (TryIBLoad) and (GetIBClientVersion >= 6) then
    RegisterComponents(IBPalette2, [TIBConfigService, TIBBackupService,
      ...
      TIBLogService, TIBSecurityService, TIBLicensingService,
      TIBServerProperties, TIBInstall, TIBUninstall]);
{$ENDIF}
...
begin
  ...
  begin
    ...
    case Index of
      0: if EditIBDataSet(TIBDataSet(Component)) then Designer.Modified;
