...
uses
  ...
  IB, IBUtils, IBSQL, IBCustomDataSet, IBDatabase, IBServices;
...
type
  ...
  IIBSQLMonitorHook = interface
    ['{D7C469E1-8CA5-47B0-B282-546FFDC725F8}']
...
const
  MonitorHookNames: array[0..5] of String = (
    'IB.SQL.MONITOR.Mutex3_1',
    'IB.SQL.MONITOR.SharedMem3_1',
    'IB.SQL.MONITOR.WriteEvent3_1',
    'IB.SQL.MONITOR.WriteFinishedEvent3_1',
    'IB.SQL.MONITOR.ReadEvent3_1',
    'IB.SQL.MONITOR.ReadFinishedEvent3_1'
  );
